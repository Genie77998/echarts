...
! function(e) {
    ...
    return i.prototype = {
        ...
        addLabel: function(e, t, i, n, a) {
            ...
            if (r.show) {
                var d = e.style;
                d.text = this._getLabelText(t, i, n, "normal"), d.textPosition = null == r.position ? "horizontal" === a ? "right" : "top" : r.position, d.textColor = l.color, d.textFont = this.getFont(l), d.textAlign = l.align, d.textBaseline = l.baseline , d.rotate = r.rotate;
            }
            if (s.show) {
