define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function(e) {
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            for (var t, i, n, a, o = this.component.legend, r = {}, s = {}, l = {}, h = {}, V = 0, d = e.length; d > V; V++)
                if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), i = e[V].mapType, s[i] = s[i] || {}, s[i][V] = !0, l[i] = l[i] || e[V].mapValuePrecision, this._scaleLimitMap[i] = this._scaleLimitMap[i] || {}, e[V].scaleLimit && U.merge(this._scaleLimitMap[i], e[V].scaleLimit, !0), this._roamMap[i] = e[V].roam || this._roamMap[i], (null == this._hoverLinkMap[i] || this._hoverLinkMap[i]) && (this._hoverLinkMap[i] = e[V].dataRangeHoverLink), this._nameMap[i] = this._nameMap[i] || {}, e[V].nameMap && U.merge(this._nameMap[i], e[V].nameMap, !0), this._activeMapType[i] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[i] = this._selectedMode[i] || e[V].selectedMode, (null == this._hoverable[i] || this._hoverable[i]) && (this._hoverable[i] = e[V].hoverable), (null == this._clickable[i] || this._clickable[i]) && (this._clickable[i] = e[V].clickable), (null == this._showLegendSymbol[i] || this._showLegendSymbol[i]) && (this._showLegendSymbol[i] = e[V].showLegendSymbol), h[i] = h[i] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                    ...
                    for (var p = 0, g = n.length; g > p; p++) {
                        a = this._nameChange(i, n[p].name), r[i][a] = r[i][a] || {
                            seriesIndex: [],
                            valueMap: {},
                            precision: 0
                        };
                        for (var b in n[p]) "value" != b ? r[i][a][b] = n[p][b] : isNaN(n[p].value) || (null == r[i][a].value && (r[i][a].value = 0), r[i][a].precision = Math.max(this.getPrecision(+n[p].value), r[i][a].precision), r[i][a].value += +n[p].value, r[i][a].valueMap[V] = +n[p].value);
            ...
            for (var f in r) {
                for (var g in r[f]) {
                    "average" == h[f] && (r[f][g].value /= r[f][g].seriesIndex.length);
                    var k = r[f][g].value;
                    null != k && (r[f][g].value = k.toFixed(null == l[f] ? r[f][g].precision : l[f]) - 0)
                }
        ...
        _getProjectionData: function(e, t, i) {
            ...
            _globaDate.mapLeft = n.left;
            _globaDate.mapTop = n.top;
            _globaDate.posArr = s;
        ...
        _buildMap: function(e, t, i, d) {
            for (var p, c, u, y, g, b, f, k, _, x, L, W = this.series, X = this.component.legend, K = this.component.dataRange, v = 0, w = t.length; w > v; v++) {
                if (k = U.clone(t[v]), _ = {
                        name: k.name,
                        path: k.path,
                    ...
                    for (var I = 0, J = u.seriesIndex.length; J > I; I++) {
                        ...
                        g.push(C), p += C.name + " ", X && this._showLegendSymbol[e] && X.hasColor(C.name) && this.shapeList.push(new o({
                            zlevel: C.zlevel,
                            z: C.z + 1,
                            position: U.clone(k.position),
                            _mapType: e,
                ...
                switch (this.ecTheme.map && g.push(this.ecTheme.map), g.push(m.map), b = K && !isNaN(y) ? K.getColor(y) : null, k.color = k.color || b || this.getItemStyleColor(this.deepQuery(g, "itemStyle.normal.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.normal.areaStyle.color"), k.strokeColor = k.strokeColor || this.deepQuery(g, "itemStyle.normal.borderColor"), k.lineWidth = k.lineWidth || this.deepQuery(g, "itemStyle.normal.borderWidth"), _.color = this.getItemStyleColor(this.deepQuery(g, "itemStyle.emphasis.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.emphasis.areaStyle.color") || k.color, _.strokeColor = this.deepQuery(g, "itemStyle.emphasis.borderColor") || k.strokeColor, _.lineWidth = this.deepQuery(g, "itemStyle.emphasis.borderWidth") || k.lineWidth, k.brushType = _.brushType = k.brushType || "both", k.lineJoin = _.lineJoin = "round", k._name = _._name = c, f = this.deepQuery(g, "itemStyle.normal.label.textStyle"), L = {
                ...
                }, L._style = U.clone(L.style), L.highlightStyle = U.clone(L.style), this.deepQuery(g, "itemStyle.emphasis.label.show") ? (L.highlightStyle.text = this.getLabelText(c, y, g, "emphasis"), L.highlightStyle.color = this.deepQuery(g, "itemStyle.emphasis.label.textStyle.color") || L.style.color, f = this.deepQuery(g, "itemStyle.emphasis.label.textStyle") || f, L.highlightStyle.textFont = this.getFont(f)) : L.highlightStyle.color = "rgba(0,0,0,0)", x = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    position: U.clone(k.position),
                    style: k,
                    ...
                    _style: U.clone(k),
                    _mapType: e
                }, null != k.scale && (x.scale = U.clone(k.scale)), L = new n(L), x.style.shapeType) {
                    case "rectangle":
                        x = new r(x);
                        break;
                    case "line":
        ...
        __onmousewheel: function(e) {
            ...
            if (!(this.shapeList.length <= 0)) {
                    ...
                    if (d[s]) {
                        ...
                        for (var n = 0, a = this.shapeList.length; a > n; n++) {
                            ...
                            if (o._mapType == s) {
                                var _ = o.type,
                                    x = o.style;
                                switch (o.position[0] = u.left, o.position[1] = u.top, _) {
                                    case "path":
                                    case "symbol":
                                    case "circle":
                                    case "rectangle":
                ...
                if (c) {
                    ...
                    }, 100), this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                        type: "scale"
                    }, this.myChart)
                }
            }
        ...
        __onmousemove: function(e) {
            if (this._mousedown && this._isAlive) {
                ...
                this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {
                    type: "move"
                }, this.myChart), this.clearEffectShape(!0), this.zr.refreshNextFrame(), this._justMove = !0, p.stop(t)
            }
        },
